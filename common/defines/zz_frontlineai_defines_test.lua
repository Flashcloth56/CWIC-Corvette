...
NDefines.NAI.HOURS_BETWEEN_ENCIRCLEMENT_DISCOVERY = 240		
...
NDefines.NCountry.BASE_SURRENDER_LIMIT = 0.85
--------------------------------------------------------------------------------------------------------------
-- DESIGNS
--------------------------------------------------------------------------------------------------------------
...
NDefines.NAI.DEFAULT_MODULE_VARIANT_CREATION_XP_CUTOFF_AIR = 50 --25	-- Same as above but for the air designer.
...
NDefines.NAI.DESIRE_USE_XP_TO_UPDATE_LAND_TEMPLATE = 10.0 --2.0    -- How quickly is desire to update/create templates accumulated?
...
NDefines.NAI.UPGRADE_PERCENTAGE_OF_FORCES = 0.20 --0.1
NDefines.NAI.UPGRADES_DEFICIT_LIMIT_DAYS = 720 --180 --50                           -- Ai will avoid upgrading units in the field to new templates if it takes longer than this to fullfill their equipment need
...
NDefines.NAI.DEPLOY_MIN_EQUIPMENT_SURRENDER_FACTOR = 0.7	-- Required percentage of equipment (1.0 = 100%) for AI to deploy unit in wartime while surrender progress is higher than 0 
...
NDefines.NAI.DEPLOY_MIN_TRAINING_WAR_FACTOR = 0.7		-- Required percentage of training (1.0 = 100%) for AI to deploy unit in wartime
...
NDefines.NAI.NAVAL_DOCKYARDS_SHIP_FACTOR = 10			-- The extent to which number of dockyards play into amount of sips a nation wants
NDefines.NAI.NAVAL_BASES_SHIP_FACTOR = 10				-- The extent to which number of naval bases play into amount of sips a nation wants
NDefines.NAI.NAVAL_STATES_SHIP_FACTOR = 10			-- The extent to which number of states play into amount of sips a nation wants
...
NDefines.NAI.ASSIGN_TANKS_TO_NON_WAR_FRONT = 0.5 --0.4
...
NDefines.NAI.PLAN_ATTACK_MIN_ORG_FACTOR_LOW = 0.7							-- Minimum org % for a unit to actively attack an enemy unit when executing a plan
...
NDefines.NAI.ORG_UNIT_STRONG = 0.9											-- Organization % for unit to be considered strong
...
NDefines.NAI.MISSING_CONVOYS_BOOST_FACTOR = 1.0
...
NDefines.NAI.MAX_FUEL_CONSUMPTION_RATIO_FOR_AIR_TRAINING = 0.4
...
NDefines.NAI.STR_BOMB_PLANES_PER_CIV_FACTORY = 50				-- Amount of planes requested per enemy civ factory
NDefines.NAI.STR_BOMB_PLANES_PER_MIL_FACTORY = 50				-- Amount of planes requested per enemy military factory
NDefines.NAI.STR_BOMB_PLANES_PER_NAV_FACTORY = 25				-- Amount of planes requested per enemy naval factory
NDefines.NAI.STR_BOMB_PLANES_PER_SUPPLY_HUB = 10                 -- Amount of planes requested per enemy supply node
NDefines.NAI.STR_BOMB_MIN_EXCORT_PLANES = 50					-- Min amount of planes requested to escort operations
...
NDefines.NMilitary.PLAN_PORVINCE_RESISTANCE_BASE_IMPORTANCE = 150.0 -- Used when calculating the value of defense area provinces for the battle plan system (factored by resistance level) vanilla 10.0
NDefines.NMilitary.PLAN_PROVINCE_LOW_VP_IMPORTANCE_FRONT = 1.0    -- Used when calculating the value of fronts in the battle plan system vanilla 2.0
...
NDefines.NAI.MAX_SUPPLY_DIVISOR = 0.25							-- To make sure the AI does not overdeploy divisions. Higher number means more supply per unit. van 2.0
...
NDefines.NAI.DIPLOMACY_LEND_LEASE_MONTHS_TO_CANCEL = 6